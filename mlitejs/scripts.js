...
// var height = ($(window).height() - ($('.sidebar-profile').outerHeight()));

// var item = $('.sidebar-wrapper .sidebar-menu li.active')[0];
// if (item) {
//     var $el = $('.sidebarMenuScroll');
...
//     $el.overlayScrollbars(),scroll({ top: activeItemOffsetTop });
// }
