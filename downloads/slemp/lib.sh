...
Install_Libiconv()
{
	...
	echo -e "Install_Libiconv" >> /opt/slemp/server/lib.pl
}
Install_Libmcrypt()
{
	...
	echo -e "Install_Libmcrypt" >> /opt/slemp/server/lib.pl
}
Install_Mcrypt()
{
	...
	echo -e "Install_Mcrypt" >> /opt/slemp/server/lib.pl
}
Install_Mhash()
{
    ...
    cd ${run_path}
    rm -rf mhash-0.9.9.9*
	echo -e "Install_Mhash" >> /opt/slemp/server/lib.pl
}
